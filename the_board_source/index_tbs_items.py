...
# def save_html_from_item_url(itemurl):
#     # 'https://theboardsource.com/product/brand-new-95-x-23-x-3-1-16-cj-nelson-classic-longboard-surfboard/'
#     gsel = webdriver.PhantomJS()
#     gsel.get(itemurl)
#     time.sleep(2)
#     print("got src")
#     print(gsel.page_source)

#     with open('tbs_item_page_data.txt','w') as file:
#         file.write(gsel.page_source)

#     gsel.close()

# save_html_from_item_url('https://theboardsource.com/product/68-x-20-75-x-2-75-x-42l-lost-eps-crowd-killer-surfboard/')

# def get_item_urls_from_special_endpoint():
#     page=0
#     getPages = 10
#     while page < getPages:
#         gsel.get("https://theboardsource.com/wp-json/wc/v2/products?per_page=16&category=12&page="
#                  +str(page)+
#                  "&order=desc&min_price=0&max_price=200000&consumer_key=ck_f8a9d0f0a65c24b5f4363fd396c218e87b205a0f&consumer_secret=cs_997bd4619188cd08ad0ad38a8b0273854092ed8d"
#                 )
#
#         pageSource = gsel.page_source
#         split_perma = pageSource.split('permalink":"')
#
#         for bns in split_perma:
#             split_date = bns.split('","date_c')[0]
#             print("split_date:::")
#             print(split_date)
#             if "https" in split_date:
#                 with open('tbs_item_urls.txt', 'a+') as tbs_url_file:
#                     tbs_url_file.write(split_date + "\n")
#         page +=1



#allsorted = ['1150', '475', '445', '425', '385', '455', '295', '425', '525', '445', '475', '790', '825', '825', '790', '825',
#               '595', '595', '575', '595', '595', '550', '395', '595', '375', '595', '430', '575', '600', '825', '595', '595',
#               '595', '575', '595', '595', '595', '595', '595', '595', '595', '575', '550', '595', '595', '595', '595', '595',
#               '595', '225', '275', '395', '595', '595', '595', '595', '795', '595', '595', '475', '550', '445', '795', '445',
#               '445', '385', '595', '575', '595', '495', '525', '250', '445', '445', '795', '575', '765', '750', '445', '195',
#               '350', '385', '485', '745', '975', '925', '925', '625', '550', '725', '345', '875', '645', '395', '525', '600',
#               '625', '575', '575', '575', '1050', '895', '325', '925', '650', '400', '600', '545', '995', '345', '535', '395',
#               '625', '595', '595', '575', '425', '595', '800', '595', '595', '595', '295', '395', '475', '425', '425', '385',
#               '395', '340', '545', '400', '525', '395', '445', '400', '595', '595', '225', '875', '975', '1075', '1125', '445']

allsorted = ['1150', '475', '445', '425', '385', '455', '295', '425', '525', '445', '475', '790', '825', '825', '790', '825',
              '595', '595', '575', '595', '595', '550', '375', '595', '430', '575', '600', '825', '595', '595',
              '595', '575', '595', '595', '595', '595', '595', '595', '595', '575', '550', '595', '595', '595', '595', '595',
              '595', '225', '275', '395', '595', '595', '595', '595', '795', '595', '595', '475', '550', '445', '795', '445',
              '445', '385', '595', '575', '595', '495', '525', '250', '445', '445', '795', '575', '765', '750', '445', '195',
              '350', '385', '485', '745', '975', '925', '925', '625', '550', '725', '345', '875', '645', '395', '525', '600',
...
# def buildPriceList():
    ...
    #
    #         cutoffidx = 0
    #         for char in ps1[idx + 1]:
    #             cutoffidx +=1
    #             if char.isdigit() and cutoffidx < 9:
    #                 priceNums.append(char)
    #
    #         priceStr = ""
    #         pni = 0
    #         while pni < len(priceNums):
    #             priceStr += str(priceNums[pni])
    #             pni +=1
    #         sortedPrices.append(priceStr)
    #         idx +=1
    #
    ...
    # with open('PROD_PAGE_1.txt', 'w') as file:
    #     file.write(gsel.page_source)

# def buildParseItemData():
#     urlFile = 'tbs_item_urls.txt'
#     urlList = []
#
...
#
#
#         with open('SCRAPE_ITEMS/SCRAPE_PAGE_' + str(urlIndex) + '.txt', 'w') as file:
#             file.write(gsel.page_source)
#         buildItemObj = {}
#
#         if '<meta property="og:description" content="' in tbs:
#             print("got desc string ::: ")
#             split_desc = tbs.split('<meta property="og:description" content="')[1].split('">')[0]
#             print(split_desc)
#             buildItemObj["description"] = split_desc
#
#         if '<meta name="twitter:image" content="' in tbs:
#             print("got image data ::: ")
#             split_im = tbs.split('<meta name="twitter:image" content="')[1].split('">')[0]
#             print(split_im)
#             buildItemObj["imageUrl"] = split_im
#
#         if '<meta property="og:url" content="' in tbs:
#             print("got page url with slug")
#             split_url = tbs.split('<meta property="og:url" content="')[1].split('">')[0]
#             print(split_url)
#             buildItemObj["urlLink"] = split_url
#
#         buildItemObj["price"] = allsorted[urlIndex-1]
# # cant find price resort to less precise methods
#         # if "$" in tbs:
...
#         #     didx = 0
#         #     for ds in tds1:
#         #         print("price dollar loop")
#         #         # if didx == 0:
#         #         priceCandidates = []
#         #
#         #         pcidx = 0
#         #         while pcidx < 8:
#         #             if ds[len(ds)-pcidx].isdigit():
#         #                 priceCandidates += ds[len(ds)-1 - pcidx]
#         #             pcidx +=1
#         #         if len(priceCandidates) == 3 or len(priceCandidates) == 4:
#         #             print("probably found price")
#         #             bp = ""
#         #             bpidx = 0
#         #             while bpidx < len(priceCandidates):
#         #                 bp += priceCandidates[(len(priceCandidates)-1) - bpidx]
#         #                 bpidx +=1
#         #             buildItemObj["price"] = bp
#         #
#         # if '<h3 class="title is-4">' in tbs:
#         #     print("found potential price div")
#         #     print(tbs.split('<h3 class="title is-4">')[1][0:10])
#
#         if "<title>" in tbs:
#             ts1 = tbs.split("<title>")[1].split("</title>")[0]
#             print("title split")
#             print(ts1)
...
#                     # print(widthFrac)
#
#                     # print("Length feet/inches Vals ::: ")
#                     # print(lengthFeet)
#                     # print(lengthInches)
#
#                     # print("Thickness Vals ::: ")
#                     # print(thickInches)
#                     # print(thickFrac)
#
...
#                     print(buildItemObj)
#
#                 with open("built_tbs_scrape_data.txt", "a+") as file:
#                     file.write(json.dumps(buildItemObj) + "\n")

def convert_scraped_objects_to_pre_elastic():
    parseDataObjFile = 'built_tbs_scrape_data.txt'
    parseDataObjList = []
